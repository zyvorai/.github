...
Apply these in the account/org profile settings for **@zyvorai**. Requires owner permissions.
...
Org profile README (after convert-to-org): [zyvorai/.github](https://github.com/zyvorai/.github) (`profile/README.md`).
